...
public:
  ...
  /**
   * @return int 返回值 如果是1：moveing，2：停止
...
int main(int argc, char** argv) {
  ...
  auto node = std::make_shared<ExampleInterfacesRobot>("example_interfaces_robot_01_node");
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}
